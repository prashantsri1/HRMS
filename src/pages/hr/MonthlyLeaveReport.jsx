            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-8 flex flex-col md:flex-row gap-4 items-end transition-colors duration-300">
                ...
                <div className="w-full md:w-1/3">
                    ...
                    <div className="relative">
                        <select 
                            ...
                            className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-purple-500 outline-none appearance-none cursor-pointer text-gray-900 dark:text-white"
                        >
                ...
                <div className="w-full md:w-1/4">
                    ...
                    <input 
                        ...
                        className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-purple-500 outline-none text-gray-900 dark:text-white dark:[color-scheme:dark]"
                    />
                </div>
            </div>
...
const TypeBadge = ({ type, category }) => {
    ...
    const colors = {
        ...
        'Annual': 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-800',
